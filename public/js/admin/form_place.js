...
var app = new Vue({
    ...
    methods: {
        ...
        onFacilityChecked: function (facility) {
            if (!this.isFacilityChecked(facility)) {
                this.form.facilities.push({name: facility, descriptions: ''})
            } else {
        ...
        onSaveOnly: async function (close = false) {
            try {
        ...
        getIndexFasilitas: function (fasilitas) {
            let index = 0;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === fasilitas) {
                    index = i;
                }
            }
            return index
    ...
    computed: {
        ...
        hasParkingArea() {
            var condition = false;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === 'Parking Area') {
                    condition = true;
                }
            }
            return condition;
        ...
        hasMushola() {
            var condition = false;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === 'Mushola') {
                    condition = true;
                }
            }
            return condition;
        ...
        hasFreeWifi() {
            var condition = false;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === 'Free wifi') {
                    condition = true;
                }
            }
            return condition;
        ...
        hasSmokingArea() {
            var condition = false;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === 'Smoking Area') {
                    condition = true;
                }
            }
            return condition;
        ...
        hasToilet() {
            var condition = false;
            for (var i = 0; i < this.form.facilities.length; i++) {
                if (this.form.facilities[i].name === 'Toilet') {
                    condition = true;
                }
            }
            return condition;
